...
var bodyLock = (delay = 500) => {
  ...
  if (bodyLockStatus) {
    ...
    body.style.paddingRight = window.innerWidth - ((_a2 = document.querySelector(".wrapper")) == null ? void 0 : _a2.offsetWidth) + "px";
      ...
      if (!el.closest("[data-spollers]")) {
        ...
        if (spollersClose.length) {
          spollersClose.forEach((spollerClose) => {
            var spollersBlock2 = spollerClose.closest("[data-spollers]");
            var spollerCloseBlock = spollerClose.parentNode;
            if (spollersBlock2.classList.contains("_spoller-init")) {
              var spollerSpeed2 = spollersBlock2.dataset.spollersSpeed ? parseInt(spollersBlock2.dataset.spollersSpeed) : 500;
              spollerClose.classList.remove("_spoller-active");
              _slideUp(spollerClose.nextElementSibling, spollerSpeed2);
              setTimeout(() => {
...
(function() {
  document.querySelectorAll(".choises__card");
  var sectionFormBlock = document.getElementById("section-form-block");
